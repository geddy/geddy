...
/***
  ...
  @param {String/Object} options
    ...
    @param {String} [options.protocol] The protocol to use(Uses Nails's current protocol('http' default))
    ...
    @param {String} [options.domain] Specify a domain to use. Required if `relPath` is false(Uses
                                     Nails's `hostname` option as default)
...
exports.scriptLink = {
  ...
  action: function (source, htmlOptions) {
    ...
    htmlOptions = nails.mixin({ src: source }, htmlOptions)
