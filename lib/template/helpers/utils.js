...
exports.registerData = function (data) { Data = nails.mixin({params: {}}, data); };
...
exports.urls = {
  ...
  genProtocol: function (options) {
    // Generates a protocol from the options and defaults to the one used by Nails currently
    options = options || {};
  ...
  genHost: function (options) {
    ...
    if (nails.config.hostname) {
      domain = domain || nails.config.hostname;
    }
