...
controller.BaseController.prototype = new (function () {
  ...
  */
  ...
  /*
    ...
    @param {Object} [options] Options.
      @param {String|Object} [options.status] The desired flash message, can be string or an errors hash
  ...
  */
  this.respondWith = function (content, options) {
    ...
    // We don't know how to handle anything that isn't a model or collection of them,
    // so just pass thru the params
    else {
      this.respond.call(this, content);
    }
  };
