...
var _taskArgsMap = {
  'app': ['primary', 'template', 'rt', 'coffee']
, 'model': ['primary', 'model', 'modelPath', 'coffee']
, 'resource': ['primary', 'model', 'coffee']
, 'scaffold': ['primary', 'model', 'template', 'rt', 'coffee']
, 'controller': ['primary', 'template', 'coffee']
, 'secret': []
, 'auth': ['template']
, 'auth:update': []
, 'migration': ['primary']
...
Cmd.prototype = new (function () {
  ...
  this.parseArgs = function (args) {
    ...
    namedArgs.coffee = coffee;
	
	// Arguments of some jake tasks are missing or incomplete
	namedArgs.modelPath = undefined;
