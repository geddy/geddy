...
utils.mixin(Response.prototype, new (function () {
  ...
  this.sendFile = function (filepath) {
    ...
    var now = new Date();
    var expireTime = geddy.config.cacheControl.expires[contentType] || geddy.config.cacheControl.expires.default || 0;
    ...
    this.setHeaders(200, {
      ...
      'Content-Length': stats.size || (stats.blksize * stats.blocks)
    });
