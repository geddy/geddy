...
var Router = function () {
  ...
  this.resource = function (res) {
    var controller = nails.string.camelize(res, {initialCap: true});
    var cslug = nails.string.decamelize(res);
  ...
  /*
   * nails.router.first('/snow_dogs/5', 'GET')
  ...
  /*
   * nails.router.all('/snow_dogs/bob', 'GET') =>
   *  [
  ...
  /*
   * nails.router.url({ controller: 'SnowDogs', action: 'show', id: 5 }) => '/snow_dogs/5'
   *
   * nails.router.url({ controller: 'SnowDogs', action: 'show', id: 5, format: 'json' })
   *    => '/snow_dogs/5.json'
   *
  ...
  this.url = function (params) {
    ...
    params = nails.mixin({controller:'Application', action:'index' }, params);
  ...
  var Route = function () {
    ...
    this.to = function (params) {
      nails.mixin(this.params, params);
    ...
    this.parse = function (urlParam, method) {
      ...
      if (params.controller) {
        params.controller = nails.string.camelize(params.controller,
            {initialCap: true});
      }
      ...
      this.url = function (string) {
        if (this.test(string)) {
          ...
          if (this.name == 'controller') {
            return nails.string.decamelize(string);
          }
          return string;
        }
