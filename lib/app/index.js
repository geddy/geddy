...
var App = function () {
  ...
  this.handleNoMatchedRoute = function (method, reqUrl, params, reqObj, respObj) {
    ...
    // FIXME: This is done again here because it should be done after URL decode
    // to prevent directory traversal by e.g. %2e%2e%2f (which is devoded to '../')
    // decodeURIComponent should be done in request_helpers#normalizeUrl, but for now,
    // I don't do so to prevent bugs.
